<?php
namespace Isobar\CmbPaymentGateway\Controller\Payment;
...
class Qrcode extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        $params['CURLOPT_SSL_CIPHER_LIST'] ='DEFAULT:!DH';
        $params['CURLOPT_TIMEOUT'] = '150';
        $params['CURLOPT_POSTFIELDS'] = $paramStr;
